...
def submit():
    ...
    a=r.json()
    print(a)
    movie_1_plot=a.get('Plot')
    if(movie_1_plot==None):
    	movie_1_plot='API did not return us the value '
    movie_1_year=a.get('Title')
    if(movie_1_year==None):
    	movie_1_year='API did not return us the value'
    movie_1_poster=a.get('Poster')
    if(movie_1_poster==None):
    	print('API did not return us the value')
    r=requests.get('http://www.omdbapi.com/?t='+r_names[1]+'&apikey=25851263')
    a=r.json()
    movie_2_plot=a.get('Plot')
    if(movie_2_plot==None):
    	movie_2_plot='API did not return us the value '
    movie_2_year=a.get('Title')
    if(movie_2_year==None):
    	movie_2_year='API did not return us the value '
    movie_2_poster=a.get('Poster')
    if(movie_2_poster==None):
    	movie_2_poster='API did not return us the value '
    r=requests.get('http://www.omdbapi.com/?t='+r_names[3]+'&apikey=25851263')
    a=r.json()
    movie_3_plot=a.get('Plot')
    if(movie_3_plot==None):
    	movie_3_plot='API did not return us the value '
    movie_3_year=a.get('Title')
    if(movie_3_year==None):
    	movie_3_year='API did not return us the value '
    movie_3_poster=a.get('Poster')
    if(movie_3_poster==None):
    	movie_3_poster='API did not return us the value '
    r=requests.get('http://www.omdbapi.com/?t='+r_names[4]+'&apikey=25851263')
    a=r.json()
    movie_4_plot=a.get('Plot')
    if(movie_4_plot==None):
    	movie_4_plot='API did not return us the value '
    movie_4_year=a.get('Title')
    if(movie_4_year==None):
    	movie_4_year='API did not return us the value '
    movie_4_poster=a.get('Poster')
    if(movie_4_poster==None):
    	movie_4_poster='API did not return us the value '
    r=requests.get('http://www.omdbapi.com/?t='+r_names[5]+'&apikey=25851263')
    a=r.json()
    movie_5_plot=a.get('Plot')
    if(movie_5_plot==None):
    	movie_5_plot='API did not return us the value '
    movie_5_year=a.get('Title')
    if(movie_5_year==None):
    	movie_5_year='API did not return us the value '
    movie_5_poster=a.get('Poster')
    if(movie_5_poster==None):
    	movie_5_poster='API did not return us the value '
    r=requests.get('http://www.omdbapi.com/?t='+r_names[6]+'&apikey=25851263')
    a=r.json()
    movie_6_plot=a.get('Plot')
    if(movie_6_plot==None):
    	movie_6_plot='API did not return us the value '

    movie_6_year=a.get('Title')
    if(movie_6_year==None):
    	movie_6_year='API did not return us the value '
    movie_6_poster=a.get('Poster')
    if(movie_6_poster==None):
    	movie_6_poster='API did not return us the value '
    r=requests.get('http://www.omdbapi.com/?t='+r_names[7]+'&apikey=25851263')
    a=r.json()
    movie_7_plot=a.get('Plot')
    if(movie_7_plot==None):
    	movie_7_plot='API did not return us the value '
    movie_7_year=a.get('Title')
    if(movie_7_year==None):
    	movie_7_year='API did not return us the value '
    movie_7_poster=a.get('Poster')
    if(movie_7_poster==None):
    	movie_7_poster='API did not return us the value '
    r=requests.get('http://www.omdbapi.com/?t='+r_names[8]+'&apikey=25851263')
    a=r.json()
    movie_8_plot=a.get('Plot')
    if(movie_8_plot==None):
    	movie_8_plot='API did not return us the value '
    movie_8_year=a.get('Title')
    if(movie_8_year==None):
    	movie_8_year='API did not return us the value '
    movie_8_poster=a.get('Poster')
    if(movie_8_poster==None):
    	movie_8_poster='API did not return us the value '
